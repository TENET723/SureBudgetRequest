...
{
    /// <inheritdoc />
    public partial class SimplifyToMonthlyLimit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                ...
                table: "budget_requests",
                newName: "monthly_window_start_at_submission");
            ...
            migrationBuilder.RenameColumn(
                ...
                table: "budget_requests",
                newName: "monthly_window_end_at_submission");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "monthly_window_start_at_submission",
                table: "budget_requests",
                newName: "period_start_at_submission");

            migrationBuilder.RenameColumn(
                name: "monthly_window_end_at_submission",
                table: "budget_requests",
                newName: "period_end_at_submission");
